    ...
    <div class="col-12 col-md-6">
      ...
      <form @submit.prevent="submitPost">
        <div class="mb-3 d-flex flex-column align-items-center">
          ...
          <input type="text" id="title" v-model="title" class="form-control" style="max-width: 300px;">
        </div>
        <div class="mb-3 d-flex flex-column align-items-center">
          <label for="context" class="form-label">내용</label>
          <textarea id="context" v-model="context" class="form-control" rows="10" style="max-width: 300px; resize: none;"></textarea>
        </div>
        <div class="d-flex justify-content-end" style="max-width: 300px; margin: 0 auto;">
